...
SCRIPT_NAME = "fully-connected-ewc-si-stabilized"
...
def experiments_run():
    ...
    logFile = "./fully-connected-ewc-si-stabilized.log"
    ...
    exp_file = "fully-connected-ewc-si-stabilized.dmp"
    try:
    ...
    lmbdas = [0, 0.04, 0.8, 0.12, 0.16, 0.20, 0.24, 0.26, 0.28, 0.3, 0.32, 0.34, 0.36, 0.38, 0.40, 0.42, 0.44,
              0.46, 0.48, 0.5, 0.52, 0.54, 0.56, 0.58, 0.60, 0.62, 0.64, 0.66, 0.68, 0.7, 0.72, 0.74, 0.76, 0.78,
              0.80, 0.82, 0.84, 0.86, 0.88, 0.9, 0.92, 0.94, 0.96, 0.98, 1., 1.04, 1.08, 1.12, 1.16, 1.2, 1.24,
