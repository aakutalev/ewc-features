...
SCRIPT_NAME = "fully-connected-ewc-fisher-stabilized"
...
def experiments_run():
    ...
    logFile = "./fully-connected-ewc-fisher-stabilized.log"
    ...
    exp_file = "fully-connected-ewc-fisher-stabilized.dmp"
    try:
    ...
    lmbdas = [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 57.5, 60, 62.5, 65, 67.5, 70, 72.5, 75, 77.5,
              80, 82.5, 85, 87.5, 90, 92.5, 95, 97.5, 100, 102.5, 105, 17.5, 110, 112.5, 115, 117.5, 120,
